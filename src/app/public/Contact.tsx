...
const Contact = () => {
  return (
    <div
      id="CONTACT"
      className="flex h-full items-center justify-center m-auto"
    >
      <div className="flex flex-col h-full justify-end z-10 items-center py-10 space-y-5">
        ...
        {/* <div className="absolute w-full flex justify-center items-center bottom-10"></div> */}
      </div>
    </div>
  );
};
